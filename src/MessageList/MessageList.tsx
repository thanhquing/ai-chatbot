...
const MessageList: FC<IMessageListProps> = ({
  ...
  return (
    <div className={classNames(['HD_aichatbot-container-mlist', props.className])} {...props.customProps}>
      ...
      {downButton === true && _downButton && toBottomHeight !== '100%' && (
        <div className='HD_aichatbot-mlist-down-button' onClick={toBottom}>
          ...
          {props.downButtonBadge !== undefined ? (
            <span className='HD_aichatbot-mlist-down-button--badge'>{props.downButtonBadge.toString()}</span>
          ) : null}
        </div>
      )}
    </div>
