...
const Input: React.FC<IInputProps> = ({
  ...
  return (
    <div className={classNames('HD_aichatbot-container-input', props.className)}>
      {props.leftButtons && <div className='HD_aichatbot-input-buttons'>{props.leftButtons}</div>}
      {multiline === false ? (
        <input
          ref={props.referance}
          type={type}
          className={classNames('HD_aichatbot-input')}
        ...
        <textarea
          ref={props.referance}
          className={classNames('HD_aichatbot-input', 'HD_aichatbot-input-textarea')}
          placeholder={props.placeholder}
          defaultValue={props.defaultValue}
          style={props.inputStyle}
          onChange={onChangeEvent}
      ...
      {props.rightButtons && <div className='HD_aichatbot-input-buttons'>{props.rightButtons}</div>}
    </div>
  )
}
