...
const MessageBox: React.FC<MessageBoxType> = ({ focus = false, notch = true, styles, ...props }) => {
  ...
  var positionCls = classNames('HD_aichatbot-mbox', { 'HD_aichatbot-mbox-right': props.position === 'right' })
  ...
  return (
    <div ref={messageRef} className={classNames('HD_aichatbot-container-mbox', props.className)} onClick={props.onClick}>
      ...
      {props.type === 'system' ? (
        ...
        <div
          ...
          className={classNames(
            positionCls,
            { 'HD_aichatbot-mbox--clear-padding': thatAbsoluteTime },
            { 'HD_aichatbot-mbox--clear-notch': !notch },
            { 'message-focus': focus }
          )}
        >
          <div className='HD_aichatbot-mbox-body' onContextMenu={props.onContextMenu}>
            {!props.retracted && props.forwarded === true && (
              <div
                className={classNames(
                  'HD_aichatbot-mbox-forward',
                  { 'HD_aichatbot-mbox-forward-right': props.position === 'left' },
                  { 'HD_aichatbot-mbox-forward-left': props.position === 'right' }
                )}
              ...
              <div
                className={
                  props.forwarded !== true
                    ...
                    : classNames(
                        'HD_aichatbot-mbox-forward',
                        { 'HD_aichatbot-mbox-reply-btn-right': props.position === 'left' },
                        { 'HD_aichatbot-mbox-reply-btn-left': props.position === 'right' }
                      )
                }
            ...
            {!props.retracted && props.removeButton === true && (
              <div
                className={
                  props.forwarded === true
                    ? classNames(
                        'HD_aichatbot-mbox-remove',
                        { 'HD_aichatbot-mbox-remove-right': props.position === 'left' },
                        { 'HD_aichatbot-mbox-remove-left': props.position === 'right' }
                      )
                    : classNames(
                        'HD_aichatbot-mbox-forward',
                        { 'HD_aichatbot-mbox-reply-btn-right': props.position === 'left' },
            ...
            {(props.title || props.avatar) && (
              <div
                ...
                className={classNames('HD_aichatbot-mbox-title', {
                  'HD_aichatbot-mbox-title--clear': props.type === 'text',
                })}
              >
            ...
            {props.forwardedMessageText ? (
              <div className='HD_aichatbot-mbox-forwardedMessage'>
                <div className='HD_aichatbot-mbox-forwarded-message'>
            ...
            {props.type === 'text' && (
              <div
                className={classNames('HD_aichatbot-mbox-text', {
                  'HD_aichatbot-mbox-text-retracted': props.retracted,
            ...
            <div
              ...
              className={classNames(
                'HD_aichatbot-mbox-time',
                { 'HD_aichatbot-mbox-time-block': thatAbsoluteTime },
            ...
            >
              ...
              {props.status && (
                <span className='HD_aichatbot-mbox-status'>
          ...
          {notch &&
            (props.position === 'right' ? (
              <svg
                ...
                className={classNames('HD_aichatbot-mbox-right-notch', { 'message-focus': focus })}
              ...
              <div>
                <svg
                  style={props.notchStyle}
                  className={classNames('HD_aichatbot-mbox-left-notch', { 'message-focus': focus })}
                  xmlns='http://www.w3.org/2000/svg'
                  viewBox='0 0 20 20'
                >
                  <defs>
