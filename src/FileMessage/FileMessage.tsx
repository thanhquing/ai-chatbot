...
const FileMessage: React.FC<IFileMessageProps> = props => {
  ...
  return (
    <div className='HD_aichatbot-mbox-file'>
      <button onClick={onClick}>
        <div className='HD_aichatbot-mbox-file--icon'>
          <FaFile color='#aaa' />
          <div className='HD_aichatbot-mbox-file--size'>{props?.data.size}</div>
        </div>
        <div className='HD_aichatbot-mbox-file--text'>{props.text}</div>
        <div className='HD_aichatbot-mbox-file--buttons'>
          {error && (
            <span className='HD_aichatbot-error-button'>
          ...
          {!error &&
            ...
            props?.data?.status.loading !== 0 && (
              <ProgressCircle
                ...
                className='HD_aichatbot-mbox-file--loading'
